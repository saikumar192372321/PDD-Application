    ...
    var body: some View {
            ...
            ScrollView(showsIndicators: false) {
                VStack(spacing: 24) {
                    ...
                    VStack(alignment: .leading, spacing: 6) {
                        ...
                        Text("Manage product levels and wholesale pricing")
        ...
        .toolbar {
            ToolbarItemGroup(placement: .navigationBarTrailing) {
                ...
                NavigationLink(destination: AddProductView(productStore: productStore, notificationStore: notificationStore)) {
        ...
        HStack(spacing: 16) {
            ...
            VStack(alignment: .leading, spacing: 10) {
                ...
                HStack(alignment: .bottom) {
                    ...
                    Button(action: {
                        var updated = product
                        updated.isTrending.toggle()
                        onUpdateStatus(updated)
                        HapticManager.shared.trigger(.light)
                    }) {
                        Image(systemName: product.isTrending ? "star.fill" : "star")
                            .font(.system(size: 14))
                            .foregroundColor(product.isTrending ? .orange : AppColors.textSecondary.opacity(0.4))
                            .padding(8)
                            .background(product.isTrending ? Color.orange.opacity(0.1) : Color.black.opacity(0.05))
                            .cornerRadius(8)
                    }
