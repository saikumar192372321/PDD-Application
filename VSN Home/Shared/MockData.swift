...
struct MockData {
    static let products: [GroceryProduct] = [
        ...
        GroceryProduct(
            ...
            localizedNames: [AppLanguage.english.rawValue: "Basmati Rice (Premium)", AppLanguage.hindi.rawValue: "बासमती चावल", AppLanguage.telugu.rawValue: "బాస్మతీ బియ్యం"],
            retailPrice: 3200,
            wholesalePrice: 2850,
            costPrice: 2400,
            image: "leaf.fill",
        ...
        GroceryProduct(
            ...
            localizedNames: [AppLanguage.english.rawValue: "Toor Dal (Premium)", AppLanguage.hindi.rawValue: "तूर दाल", AppLanguage.telugu.rawValue: "కందిపప్పు"],
            retailPrice: 180,
            wholesalePrice: 155,
            costPrice: 130,
        ...
        GroceryProduct(
            ...
            localizedNames: [AppLanguage.english.rawValue: "Premium Wheat Atta", AppLanguage.hindi.rawValue: "गेहूँ का आटा", AppLanguage.telugu.rawValue: "గోధుమ పిండి"],
            retailPrice: 550,
            wholesalePrice: 480,
            costPrice: 400,
            image: "bag.fill",
        ...
        GroceryProduct(
            name: "Sunflower Oil",
            localizedNames: [AppLanguage.english.rawValue: "Sunflower Oil", AppLanguage.hindi.rawValue: "सूरजमुखी तेल", AppLanguage.telugu.rawValue: "సన్ ఫ్లవర్ ఆయిల్"],
            retailPrice: 2100,
            wholesalePrice: 1850,
            costPrice: 1600,
            image: "drop.fill",
        ...
        GroceryProduct(
            name: "Pure Cow Ghee",
            localizedNames: [AppLanguage.english.rawValue: "Pure Cow Ghee", AppLanguage.hindi.rawValue: "शुद्ध गाय का घी", AppLanguage.telugu.rawValue: "ఆవు నెయ్యి"],
            retailPrice: 650,
            wholesalePrice: 580,
            costPrice: 500,
            image: "flame.fill",
        ...
        GroceryProduct(
            ...
            localizedNames: [AppLanguage.english.rawValue: "Biscuits Assorted", AppLanguage.hindi.rawValue: "मिश्रित बिस्कुट", AppLanguage.telugu.rawValue: "బిస్కెట్లు"],
            retailPrice: 220,
            wholesalePrice: 180,
            costPrice: 150,
        ...
        GroceryProduct(
            ...
            localizedNames: [AppLanguage.english.rawValue: "Massala Peanuts", AppLanguage.hindi.rawValue: "मसाला मूंगफली", AppLanguage.telugu.rawValue: "మసాలా వేరుశనగలు"],
            retailPrice: 120,
            wholesalePrice: 95,
            costPrice: 75,
            image: "mouth",
        ...
        GroceryProduct(
            ...
            localizedNames: [AppLanguage.english.rawValue: "Dishwash Liquid", AppLanguage.hindi.rawValue: "डिशवॉश लिक्विड", AppLanguage.telugu.rawValue: "డిష్ వాష్ లిక్విడ్"],
            retailPrice: 450,
            wholesalePrice: 380,
            costPrice: 320,
            image: "sparkles",
        ...
        GroceryProduct(
            ...
            localizedNames: [AppLanguage.english.rawValue: "Detergent Powder", AppLanguage.hindi.rawValue: "डिटर्जेंट पाउडर", AppLanguage.telugu.rawValue: "డిటర్జెంట్ పౌడర్"],
            retailPrice: 850,
            wholesalePrice: 720,
            costPrice: 600,
            image: "tshirt.fill",
