...
- Name: smoke.spec.ts >> Smoke Tests for CI/CD >> TC_SMOKE_002 - Verify Store Navigation Bar is present
- Location: automation/tests/smoke.spec.ts:12:7
...
Call log:
  ...
  - waiting for locator('nav.store-nav')
