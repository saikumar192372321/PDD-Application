...
CREATE TABLE IF NOT EXISTS users (
    ...
    otp           VARCHAR(6)    DEFAULT NULL,             -- For password reset
    otp_expiry    DATETIME      DEFAULT NULL,             -- OTP expiry time
...
-- Default admin — password is bcrypt hash of "sai1@141"
-- To regenerate: php -r "echo password_hash('sai1@141', PASSWORD_BCRYPT);"
INSERT IGNORE INTO admins (email, password) VALUES ('sai1@vsn.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi');
